...
class ColBlColSlSolver:
    ...
    def __init__(self, *, config: ColBlColSlSolverConfig) -> None:
        self._config = config
    ...
    def _solve_dc_impl[
        ...
        *,
        ...
        # Shape: [..., num_col, num_row]
        v_bl_node__V, v_sl_node__V = self._wire_ir_drop_seed(
            i_cell__uA,
            v_bl_clamp_grid__V,
            v_sl_drive_grid__V,
            bl_segment_r__MOhm,
        ...
        for outer_step in range(self._config.n_outer):
            ...
            for inner_step in range(n_inner):
                ...
                dv_bl_node__V, dv_sl_node__V = self._wire_newton_coupled_block2x2(
                    f_bl_kcl__uA,
                    f_sl_kcl__uA,
                    g_cell_bl_eff__uS,
                    g_cell_sl_eff__uS,
