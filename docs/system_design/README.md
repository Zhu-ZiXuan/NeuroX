...
- [xbar_solve](xbar_solve.md) — which component owns each shape and operation in one array DC solve, why the chunk loop bounds memory without moving a number, and what probing the iteration costs
