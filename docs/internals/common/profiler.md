...
- **Reference**: N/A — the profiler has no physics spec; per-subsystem PPA cost models live under [reference/](../../reference/README.md) (e.g. [reference/xbar/_1t1r/circuit_core](../../reference/xbar/_1t1r/circuit_core.md), [reference/digital/accumulator](../../reference/digital/accumulator.md))
