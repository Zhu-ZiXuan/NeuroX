...
`XbarCell1t1rLinear` (`neurox/primitive/xbar/cell/_1t1r_linear.py`) is the table-driven linearized 1T1R model: no device children, buffers only, closed-form branch. The shared 1T1R substrate lives at [1T1R cell base](cell.md).
