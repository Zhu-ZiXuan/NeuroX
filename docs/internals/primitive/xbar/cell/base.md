...
- **A model-specific residual uses a colocated probe link.** When a cell exposes a residual diagnostic, its concrete module defines the record, prober, and emission frequency. Cells without such a diagnostic define no probe link.
