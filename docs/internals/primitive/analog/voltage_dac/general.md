...
- **Construction.** `__init__` follows the [voltage DAC base](base.md) keyword signature and registers `_code_to_signal` as a non-persistent buffer at the constructor `dtype`.
