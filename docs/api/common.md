...
The `encoding` subpackage sits alongside them, holding the fixed-length positional transcoders that convert an integer to a digit representation and back.
