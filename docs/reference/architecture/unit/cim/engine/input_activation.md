...
The stage owns the `P`-axis serial accumulator through `InputActivationStageConfig`. Geometric block routing, weight slicing, and input-value slicing remain independent.
