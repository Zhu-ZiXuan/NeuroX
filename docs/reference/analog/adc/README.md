...
- [base](base.md) — the abstract `ADC` contract: signed-code convention, floor semantics, multi-mode operating point, what the ADC does and does not own.
- [general](general.md) — the boundary-bucketize behavioural ADC.
- [mcs_sar](mcs_sar.md) — the V_cm-based (Merged Capacitor Switching) differential SAR ADC.
