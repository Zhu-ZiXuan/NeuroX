...
The simplest member of the [ADC family](family.md): a single-mode digitizer whose resolution is fixed by a calibrated list of comparator thresholds, obeying the family signed-code and floor-quantization contract.
...
- **Internals**: [general internals](../../../../internals/primitive/analog/adc/general.md)
