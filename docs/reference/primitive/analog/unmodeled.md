...
A real circuit block whose internal transfer is out of modelling scope, represented by lumped area, standing power, and per-operation dynamic energy. It reserves a hardware budget without asserting an internal circuit decomposition or data-transfer law.
