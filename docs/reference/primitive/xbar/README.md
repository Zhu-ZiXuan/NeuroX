...
- [cell_1t1r_linear](cell/_1t1r/cell_linear.md) — the operating-point linearized 1T1R branch model (per-state chord-conductance and drop-fraction tables, division-free closed form).
