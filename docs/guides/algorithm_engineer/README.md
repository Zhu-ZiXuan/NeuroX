...
- [Reference: xbar solver](../../reference/xbar/_1t1r/solver.md) — the physical-array solve; the nested solver is the production default, the full-Jacobian solver is the debug / cross-check reference.
