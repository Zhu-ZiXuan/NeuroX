...
- On a class-header declaration the annotation trails the declaration and states the attribute's terminal shape:
  ...
  ```python
  _fabricated_name: Tensor  # Shape: [*inst_shape, item_num]
  ```
