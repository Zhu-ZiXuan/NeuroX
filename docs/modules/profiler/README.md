...
- [`docs/modules/common/circuit.md`](../common/circuit.md) — `CircuitBase` / `CircuitConfig` dev doc
- [`docs/dev/architecture/profiler_and_ppa.md`](../../dev/architecture/profiler_and_ppa.md) — full PPA + event rules across the layer hierarchy
- [`docs/dev/architecture/chunking.md`](../../dev/architecture/chunking.md) — chunking strategy
- [`docs/dev/roadmap.md`](../../dev/roadmap.md) — CSV / JSON export and benchmark suite plans
