...
For macro-level geometric chunking (tile), use the chunk-and-pad staticmethod on the xbar macro abstract base — see [`docs/dev/architecture/xbar_macro.md`](../../../dev/architecture/xbar_macro.md).
