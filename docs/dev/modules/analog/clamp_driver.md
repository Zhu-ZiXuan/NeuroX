...
Any concrete clamp driver that satisfies this contract — whether a feedback-loop TIA, an ideal voltage source, or a future variant — plugs into a generic crossbar solver through this Protocol without the solver having to import any concrete class.
