...
The `DAC` family converts integer codes to analog voltages. It follows the project-wide polymorphic-family pattern (see [`architecture/config_and_construction.md`](../../../architecture/config_and_construction.md)).
