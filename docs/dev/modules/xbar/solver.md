...
The solver framework (base class + registry + DCOP / Residuals containers) lives with its topology family. For 1T1R, see `docs/dev/modules/xbar/_1t1r/solver.md`.
...
- `docs/dev/modules/xbar/_1t1r/solver.md` — 1T1R solver framework (base + registry + DCOP)
